      ...
      <div className={Classes.DIALOG_BODY}>
        ...
        <HelpSection>
          ...
          <p>
            ...
            versions exist, their file contents, and their direct dependencies.
            This is useful for verifying if a package name is correct or if your
            regex filter will match the desired versions.
          </p>
        </HelpSection>
        ...
        <HelpSection>
          ...
          <p>
            Registers a new "Root" artifact in Backpack. Once added, the system
            will begin recursive discovery of all its versions and dependencies.
          </p>
          <Callout
        ...
        <HelpSection>
          ...
          <p>
            Forces the system to re-scan the upstream registry for an existing
            artifact. This is used when you know a new version has been released
            upstream but Backpack hasn't picked it up yet.
          </p>
        </HelpSection>
        ...
        <HelpSection>
          ...
          <p>
            Verifies the integrity of mirrored files. This action checks that
            every file registered in the Backpack metadata actually exists in S3
            storage and matches the recorded metadata. Useful for auditing the
            health of your local mirror.
          </p>
        </HelpSection>
        ...
        <HelpSection>
          ...
          <p>
            Triggers an immediate download attempt for specific versions that
            may have failed or are stuck in a pending state.
          </p>
        </HelpSection>

        <H5 style={{ marginTop: '32px' }}>Administrative Actions</H5>
        <Divider />
        ...
        <HelpSection>
          ...
          <p>
            Review and vet artifact requests from users. Admins can inspect the
            metadata and regex filters before allowing the ingestion to start.
          </p>
        </HelpSection>
        ...
        <HelpSection>
          ...
          <p>
            Generate and revoke API keys for automation. Keys can be scoped as{' '}
            <b>User</b> (read-only/add) or <b>Administrator</b> (destructive
            actions).
          </p>
        </HelpSection>
        ...
        <HelpSection>
          ...
          <p>
            Permanently removes an artifact and all its tracked metadata/files
            from the mirror.
          </p>
        </HelpSection>
      </div>
